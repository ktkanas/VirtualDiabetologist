...
| **Actual Result**   | DR status displayed clearly: **"No Diabetic Retinopathy Detected"** |
| **Status**          | ✅ **Pass** |
...
| **Actual Result**   | PDF report downloaded with diagnosis summary |
| **Status**          | ✅ **Pass** |
...
| **Actual Result**   | Error displayed: **"Invalid file type. Please upload an image."** |
| **Status**          | ❌ **Fail** (Handled, but error message can be improved) |
...
| **Actual Result**   | System shows: **"Image processing failed. Please upload a valid image."** |
| **Status**          | ❌ **Fail** (Error handled, but lacks clear cause explanation) |
...
| **Actual Result**   | Image uploaded and processed successfully without delay |
| **Status**          | ✅ **Pass** |
...
| **Actual Result**   | JSON response received: `{ "status": "success", "result": "No DR" }` |
| **Status**          | ✅ **Pass** |
